...
static Scalar ballisticLogLikelihood(const Eigen::Matrix<Scalar,Eigen::Dynamic,1> & y, const Eigen::Matrix<Scalar,Eigen::Dynamic,1> & x, const Eigen::Matrix<Scalar,Eigen::Dynamic,1> & u, const BallisticParameters & param)
{
    // Evaluate log N(y;h(x),R)
    Eigen::Matrix<Scalar,Eigen::Dynamic,1> h(y.size());
    Eigen::Matrix<Scalar,Eigen::Dynamic,Eigen::Dynamic> SR(y.size(),y.size());
...
double BallisticLogLikelihood::operator()(const Eigen::VectorXd & y, const Eigen::VectorXd & x, const Eigen::VectorXd & u, const BallisticParameters & param)
{
    // Evaluate log N(y;h(x),R)
    return ballisticLogLikelihood(y, x, u, param);
}

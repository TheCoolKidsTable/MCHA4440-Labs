...
struct BallisticLogLikelihood
{
    double operator()(const Eigen::VectorXd & y, const Eigen::VectorXd & x, const Eigen::VectorXd & u, const BallisticParameters & param);
    double operator()(const Eigen::VectorXd & y, const Eigen::VectorXd & x, const Eigen::VectorXd & u, const BallisticParameters & param, Eigen::VectorXd &g);
    double operator()(const Eigen::VectorXd & y, const Eigen::VectorXd & x, const Eigen::VectorXd & u, const BallisticParameters & param, Eigen::VectorXd &g, Eigen::MatrixXd &H);
};

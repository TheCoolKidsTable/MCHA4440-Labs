...
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
void SlamProcessModel::operator()(const Eigen::VectorXd & x, const Eigen::VectorXd & u, Eigen::VectorXd & f)
{
...
void SlamProcessModel::operator()(const Eigen::VectorXd & x, const Eigen::VectorXd & u, Eigen::VectorXd & f, Eigen::MatrixXd & SQ)
{
...
void SlamProcessModel::operator()(const Eigen::VectorXd & x, const Eigen::VectorXd & u, Eigen::VectorXd & f, Eigen::MatrixXd & SQ, Eigen::MatrixXd & dfdx)
{
...
void SlamMeasurementModel::operator()(const Eigen::VectorXd & x, const Eigen::VectorXd & u, Eigen::VectorXd & h, std::vector<Marker> & detected_markers )
{
    // TODO: mean function
...
void SlamMeasurementModel::operator()(const Eigen::VectorXd & x, const Eigen::VectorXd & u, Eigen::VectorXd & h, std::vector<Marker> & detected_markers, Eigen::MatrixXd & SR)
{
...
void SlamMeasurementModel::operator()(const Eigen::VectorXd & x, const Eigen::VectorXd & u, Eigen::VectorXd & h, std::vector<Marker> & detected_markers, Eigen::MatrixXd & SR, Eigen::MatrixXd & dhdx)
{
    // const double & r1   = param.r1;
    // const double & r2   = param.r2;
